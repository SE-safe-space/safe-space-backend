package knu.soft.safespace.jwt;
...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/auth/**", "/safe/consult/counselor", "/safe/consult/counselor/**", "/safe/board/view", "/safe/board/view/**", "/safe/board/comment/**" ).permitAll()
